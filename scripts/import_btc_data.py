...
Delegate trực tiếp sang module chuẩn aic_model_searching.preprocessing.import_btc_data
...
from aic_model_searching.preprocessing.import_btc_data import build_btc_metadata  # noqa: E402
